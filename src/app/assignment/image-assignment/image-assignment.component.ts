...
export class ImageAssignmentComponent {
  ...
  footerNoteEditorHTML: string = this.noteService.getNote(this.assignment.footerNote)?.editorHTML;
  ...
  async toPdfS89() {
    ...
    this.sharedService.saveBlobAsPdfFile(pdfBytes, this.sharedService.getFilename(this.assignment));
  }
}
